class Transaction < ActiveRecord::Base
  ...
  def upload_to_quickbooks
    ...
    when 'invoice'
      if self.paypal_account and (self.paypal_account.devex_user or !@product.batch_qb_name.blank?) and (!self.paypal_account.devex_user.qb_member_name.blank? or !@product.batch_qb_name.blank?)
        items = [self.product]
